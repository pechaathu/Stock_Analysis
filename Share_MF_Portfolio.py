...
#     stock_data[f'{col}_lag1'] = stock_data[col+"_"+stock_symbol].shift(1)
#     stock_data[f'{col}_lag2'] = stock_data[col+"_"+stock_symbol].shift(2)

# features = ['Open_lag1', 'High_lag1', 'Low_lag1', 'Close_lag1', 'Open_lag2', 'High_lag2', 'Low_lag2', 'Close_lag2']
# targets = ['Open'+"_"+stock_symbol, 'High'+"_"+stock_symbol, 'Low'+"_"+stock_symbol, 'Close'+"_"+stock_symbol]

# X = stock_data[features]
# y = stock_data[targets]
...
# print("Forecasted Prices for the Next Day:")
# print(f"Open: {forecast[0][0]:.2f}")
# print(f"High: {forecast[0][1]:.2f}")
# print(f"Low: {forecast[0][2]:.2f}")
# print(f"Close: {forecast[0][3]:.2f}")
